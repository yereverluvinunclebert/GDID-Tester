...
Private Sub btnGenerate_Click()
    ...
    Call ReplaceMatchingDeviceIds(gsPreviousRegValue, gsAutoGeneratedGDID)
...
Private Function fGDIDStatusChanged() As Boolean
    ...
    If GDID <> "" Then
        ...
        If GDID = gsPreviousRegValue Then
            fGDIDStatusChanged = False
        Else
            If gsPreviousRegValue = "" Then gsPreviousRegValue = GDID
...
Private Sub modifyExtendedPropertiesLid(ByVal newGDID As String)
    ...
    If chkAutomaticGeneration.Value = 1 Then
            ...
            End If
            Call writeLogFile("Changed from - " & gsPreviousRegValue)
